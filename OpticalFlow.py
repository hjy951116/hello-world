...
t # Upper Threshold value for the vectors to be plotted
        ...
        '''
        This procedure implements the LK optical flow estimation algorithm with two frame data and without the pyramidal approach.
        '''
...
lkwop('./allframespng/000000.png','./allframespng/000001.png',t)
# lkwop('./allframespng7.png','./Optical-Flow-master/grove2.png',t)
# lkwop('./Optical-Flow-master/teddy1.png','./Optical-Flow-master/teddy2.png',t)